...
public class mMenuBL extends clsMainBL {
	...
	public List<mMenuData> getDatabyParentId(int id){
		...
		for (mMenuData data : listData) {
    		...
    		}else if(data.get_TxtDescription().contains("mnAbsenKBN") || data.get_TxtDescription().contains("mnInventoryKBN")
    				|| data.get_TxtDescription().contains("mnInventoryOut") || data.get_TxtDescription().contains("mnStockopname")
    				|| data.get_TxtDescription().contains("mnPushDataData") || data.get_TxtDescription().contains("mnReportKBN")){
