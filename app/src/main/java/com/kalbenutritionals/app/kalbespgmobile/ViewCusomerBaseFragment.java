...
public class ViewCusomerBaseFragment extends Fragment implements IXListViewListener {
    ...
    static ViewCusomerBaseFragment instance;

    View v;

    public static ViewCusomerBaseFragment getInstance() {
        if(instance == null){
            instance = new ViewCusomerBaseFragment();
        }
        return instance;
    }
