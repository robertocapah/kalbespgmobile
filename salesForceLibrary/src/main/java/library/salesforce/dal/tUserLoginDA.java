...
public class tUserLoginDA {
	...
	public tUserLoginData getData(SQLiteDatabase db,int id) {
		...
		Cursor cursor = db.query(TABLE_CONTACTS, new String[] { dt.Property_intId,
						...
						dt.Property_TxtDeviceId,dt.Property_DtCheckIn,dt.Property_DtCheckOut,dt.Property_DtLogOut,dt.Property_TxtCab,dt.Property_txtDataId, dt.Property_txtOutletCode, dt.Property_txtOutletName, dt.Property_txtBranchCode }, dt.Property_intId + "=?",
		...
		if(cursor.getCount()>0){
			contact = new tUserLoginData(Integer.parseInt(cursor.getString(0)),
					...
					cursor.getString(8), cursor.getString(9), cursor.getString(10), cursor.getString(11), cursor.getString(12), cursor.getString(13), cursor.getString(14),cursor.getString(15),cursor.getString(16), cursor.getString(17), cursor.getString(18), cursor.getString(19));
			// return contact
		}
		cursor.close();
		return contact;
